...
import { Plus, Edit, Trash2, Home, RefreshCw, Zap,Video ,User} from 'lucide-react';
  ...
  const adminOptions = [
    {
      ...
      description: 'Add a new Coding Problem to the Logic Leet',
      icon: Plus,
      color: 'btn-success',
    ...
    },
    {
      ...
      description: 'Edit Existing Problems and their Test Cases',
      icon: Edit,
      color: 'btn-warning',
    ...
    },
    {
      ...
      description: 'Remove Problems from the Logic Leet',
      icon: Trash2,
      color: 'btn-error',
      bgColor: 'bg-error/10',
      route: '/admin/delete'
    ...
    },
    {
      id: 'makeAdmin',
      title: 'Appoint Admin',
      description: 'Appoint Other Users as Admin',
      icon: User,
      color: 'btn-warning',
      bgColor: 'bg-warning/10',
