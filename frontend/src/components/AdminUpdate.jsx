...
import AdminUpdateProblem from './AdminUpdateProblem';
...
const AdminUpdate = () => {
  ...
  const handleUpdate = async (problemId) => {
    ...
    try {
     ...
     return (   <AdminUpdateProblem problemId={problemId} />)
              ...
              <tr key={problem._id}>
                ...
                <td>
                  <div className="flex space-x-2">
                    <NavLink to={`/admin/update/${problem._id}`} className="btn btn-sm btn-info">
                    Update
                </NavLink>
                  </div>
                </td>
